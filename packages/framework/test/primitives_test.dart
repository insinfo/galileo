...
main() {
  ...
  setUp(() {
    app = Galileo(reflector: MirrorsReflector())..configuration['global'] = 305; // Pitbull!
  ...
  test('unparsed primitive throws error', () async {
    try {
      ...
      throw StateError('ArgumentError should be thrown if a parameter cannot be resolved.');
    } on ArgumentError {
      // Success
    }
  });
