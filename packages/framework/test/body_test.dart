...
void main() {
  ...
  Future<RequestContext> request(
      {bool asJson = true, bool parse = true, Map<String, dynamic> bodyFields, List bodyList}) async {
  ...
  test('deserializeBody', () async {
    var req = await request(asJson: true, bodyFields: {'text': 'Hey', 'complete': false});
...
class Todo {
  ...
  static Todo fromMap(Map m) => Todo(text: m['text'] as String, completed: m['complete'] as bool);
}
