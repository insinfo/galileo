...
class Todo {
  ...
  static Todo fromMap(Map<String, dynamic> json) {
    return Todo(id: json['id'] as String, text: json['text'] as String, complete: json['complete'] as bool);
  }
  ...
  @override
  bool operator ==(other) => other is Todo && other.text == text && other.complete == complete;
