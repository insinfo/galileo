...
class Http2ResponseContext extends ResponseContext<ServerTransportStream> {
  ...
  bool _isDetached = false, _isClosed = false, _streamInitialized = false, _isPush = false;
  ...
  Http2ResponseContext push(String path, {Map<String, String> headers = const {}, String method = 'GET'}) {
