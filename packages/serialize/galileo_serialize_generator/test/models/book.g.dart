...
part of galileo_serialize.test.models.book;
...
class Book extends _Book {
  ...
  bool operator ==(other) {
    return other is _Book &&
        ...
        ListEquality<double>(DefaultEquality<double>()).equals(other.notModels, notModels) &&
        other.camelCaseString == camelCaseString;
  }

  @override
  int get hashCode {
    return hashObjects([id, createdAt, updatedAt, author, title, description, pageCount, notModels, camelCaseString]);
  }
...
class Author extends _Author {
  ...
  bool operator ==(other) {
    return other is _Author &&
        ...
        other.name == name &&
        other.age == age &&
        ListEquality<_Book>(DefaultEquality<_Book>()).equals(other.books, books) &&
  ...
  @override
  int get hashCode {
    return hashObjects([id, createdAt, updatedAt, name, age, books, newestBook, secret, obscured]);
  }
...
class Library extends _Library {
  Library({this.id, this.createdAt, this.updatedAt, Map<String, _Book> collection})
  ...
  Library copyWith({String id, DateTime createdAt, DateTime updatedAt, Map<String, _Book> collection}) {
    return Library(
        id: id ?? this.id,
        createdAt: createdAt ?? this.createdAt,
        updatedAt: updatedAt ?? this.updatedAt,
  ...
  bool operator ==(other) {
    return other is _Library &&
        ...
        other.createdAt == createdAt &&
        other.updatedAt == updatedAt &&
        MapEquality<String, _Book>(keys: DefaultEquality<String>(), values: DefaultEquality<_Book>())
...
class Bookmark extends _Bookmark {
  Bookmark(_Book book, {this.id, this.createdAt, this.updatedAt, List<int> history, @required this.page, this.comment})
  ...
  Bookmark copyWith(_Book book,
      {String id, DateTime createdAt, DateTime updatedAt, List<int> history, int page, String comment}) {
  ...
  bool operator ==(other) {
    return other is _Bookmark &&
        ...
        other.createdAt == createdAt &&
        other.updatedAt == updatedAt &&
        ListEquality<int>(DefaultEquality<int>()).equals(other.history, history) &&
        other.page == page &&
...
class BookSerializer extends Codec<Book, Map> {
  ...
  static Book fromMap(Map map) {
    return Book(
        ...
        notModels: map['not_models'] is Iterable ? (map['not_models'] as Iterable).cast<double>().toList() : null,
  ...
  static Author fromMap(Map map) {
    ...
    return Author(
        ...
        books: map['books'] is Iterable
            ? List.unmodifiable(((map['books'] as Iterable).whereType<Map>()).map(BookSerializer.fromMap))
            : null,
        newestBook: map['newest_book'] != null ? BookSerializer.fromMap(map['newest_book'] as Map) : null,
  ...
  static Library fromMap(Map map) {
    return Library(
        ...
        collection: map['collection'] is Map
            ? Map.unmodifiable((map['collection'] as Map).keys.fold({}, (out, key) {
                return out..[key] = BookSerializer.fromMap(((map['collection'] as Map)[key]) as Map);
              }))
            : null);
  }
...
abstract class LibraryFields {
  static const List<String> allFields = <String>[id, createdAt, updatedAt, collection];
    ...
    return Bookmark(book,
        ...
        updatedAt: map['updated_at'] != null
            ? (map['updated_at'] is DateTime
                ...
                : DateTime.parse(map['updated_at'].toString()))
            : null,
        history: map['history'] is Iterable ? (map['history'] as Iterable).cast<int>().toList() : null,
...
abstract class BookmarkFields {
  static const List<String> allFields = <String>[id, createdAt, updatedAt, history, page, comment];
