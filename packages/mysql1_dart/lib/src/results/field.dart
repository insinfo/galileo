...
class Field {
  ...
  Field._internal(this.catalog, this.db, this.table, this.orgTable, this.name, this.orgName, this.characterSet,
      this.length, this.type, this.flags, this.decimals, this.defaultValue);
  ...
  factory Field(Buffer buffer) {
    ...
    return Field._internal(
        catalog, db, table, orgTable, name, orgName, characterSet, length, type, flags, decimals, defaultValue);
  }
