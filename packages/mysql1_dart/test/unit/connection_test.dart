...
library galileo_mysql.test.unit.connection_test;

import 'dart:async';

import 'package:mocktail/mocktail.dart';
import 'package:galileo_mysql/src/buffer.dart';
import 'package:galileo_mysql/src/buffered_socket.dart';
...
void main() {
  ...
  group('Connection', () {
    ...
    test('should send buffer', () async {
      ...
      captured =
          verify(() => socket.writeBufferPart(captureAny<Buffer>(), captureAny<int>(), captureAny<int>())).captured;
    ...
    test('should send large buffer', () async {
      ...
      var captured = verify(
        () => socket.writeBufferPart(captureAny<Buffer>(), captureAny<int>(), captureAny<int>()),
      ).captured;
