...
library galileo_mysql.handshake_handler_test;

import 'package:galileo_mysql/src/auth/auth_handler.dart';
import 'package:galileo_mysql/src/auth/character_set.dart';
import 'package:galileo_mysql/src/auth/handshake_handler.dart';
import 'package:galileo_mysql/src/auth/ssl_handler.dart';
import 'package:galileo_mysql/src/buffer.dart';
import 'package:galileo_mysql/src/handlers/handler.dart';
import 'package:galileo_mysql/src/mysql_client_error.dart';
...
void main() {
  group('HandshakeHandler._readResponseBuffer', () {
    test('throws if handshake protocol is not 10', () {
      var handler = HandshakeHandler('', '', MAX_PACKET_SIZE, CharacterSet.UTF8MB4);
    ...
    test('set values and does not throw if handshake protocol is 10', () {
      ...
      var db = 'db';
      var handler = HandshakeHandler(user, password, MAX_PACKET_SIZE, CharacterSet.UTF8MB4, db, true, true);
