library galileo_mysql.prepared_statements_test;
...
void main() {
  group('read fields:', () {
    ...
    test('can read INT24s', () {
      var dataPacket = BinaryDataPacket.forTests(null);
      var buffer = Buffer.fromList([0, 0, 0, 0, 255, 255, 255, 255, 255, 0, 0, 0]);
    ...
    test('can read LONGLONGs', () {
      var dataPacket = BinaryDataPacket.forTests(null);
      var buffer =
          Buffer.fromList([0, 0, 0, 0, 0, 0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255, 255, 0, 0, 0, 0, 0, 0, 0]);
    ...
    test('can read JSON', () {
      ...
      var buffer = Buffer.fromList(
          [15, 0x7b, 0x22, 0x74, 0x65, 0x73, 0x74, 0x22, 0x3a, 0x22, 0x74, 0x65, 0x73, 0x74, 0x22, 0x7d]);
      var j = {'test': 'test'};
