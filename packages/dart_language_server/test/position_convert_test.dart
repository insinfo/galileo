import 'package:galileo_dart_language_server/src/position_convert.dart';
  ...
  [false, true].forEach((windowsFile) {
    if (windowsFile)
      group('${windowsFile ? "Windows" : "macOS"} line endings', () {
        final lines = findLineLengths(windowsFile ? file.replaceAll("\n", "\r\n") : file);
        group('offsetFromPosition', () {
          ...
          test('line after blank', () async {
            var lineAfterBlank = Position((b) => b
              ..line = 3
              ..character = 0);
            expect(offsetFromPosition(lines, lineAfterBlank), windowsFile ? 25 : 22);
          });
        });
        ...
        group('rangeFromOffset', () {
          ...
          test('across lines', () async {
            expect(
                rangeFromOffset(lines, windowsFile ? 15 : 14, windowsFile ? 13 : 11).toJson(),
                Range((b) => b
                  ..start = Position((b) => b
                    ..line = 1
                    ..character = 7)
