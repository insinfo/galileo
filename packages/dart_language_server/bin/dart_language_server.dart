...
import 'package:galileo_dart_language_server/dart_language_server.dart';
import 'package:galileo_dart_language_server/src/args.dart';

Future main(List<String> args) async {
  stderr.writeln('This server is deprecated. Use the Dart Analysis Server with `--lsp`\n'
