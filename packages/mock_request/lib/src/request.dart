...
class MockHttpRequest implements HttpRequest, StreamSink<List<int>>, StringSink {
  ...
  @override
  HttpConnectionInfo connectionInfo = MockHttpConnectionInfo(remoteAddress: InternetAddress.loopbackIPv4);
  ...
  /*@override
  Stream<E> asyncExpand<E>(Stream<E> Function(Uint8List event) convert) => _stream.stream.asyncExpand(convert);*/

  @override
  Stream<E> asyncExpand<E>(Stream<E>? Function(Uint8List event) convert) {
    return _stream.stream.asyncExpand(convert);
  }

  @override
  Stream<E> asyncMap<E>(FutureOr<E> Function(Uint8List event) convert) => _stream.stream.asyncMap(convert);
  ...
  @override
  Future<bool> every(bool Function(Uint8List element) test) => _stream.stream.every(test);

  @override
  Stream<S> expand<S>(Iterable<S> Function(Uint8List value) convert) => _stream.stream.expand(convert);

  @override
  Future<Uint8List> get first => _stream.stream.first;

  @override
  Future<Uint8List> firstWhere(bool Function(Uint8List element) test, {List<int> Function()? orElse}) =>
  ...
  @override
  Future forEach(void Function(Uint8List element) action) => _stream.stream.forEach(action);

  @override
  Stream<Uint8List> handleError(Function onError, {bool Function(Object?)? test}) =>
  ...
  @override
  Future<Uint8List> lastWhere(bool Function(Uint8List element) test, {List<int> Function()? orElse}) =>
  ...
  @override
  Stream<S> map<S>(S Function(Uint8List event) convert) => _stream.stream.map(convert);

  @override
  Future pipe(StreamConsumer<List<int>> streamConsumer) => _stream.stream.cast<List<int>>().pipe(streamConsumer);
  ...
  @override
  Stream<Uint8List> skipWhile(bool Function(Uint8List element) test) => _stream.stream.skipWhile(test);

  @override
  Stream<Uint8List> take(int count) => _stream.stream.take(count);

  @override
  Stream<Uint8List> takeWhile(bool Function(Uint8List element) test) => _stream.stream.takeWhile(test);
  ...
  @override
  Stream<Uint8List> where(bool Function(Uint8List event) test) => _stream.stream.where(test);
