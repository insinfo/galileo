...
class MockHttpHeaders extends HttpHeaders {
  ...
  @override
  DateTime? get date =>
      _data.containsKey(HttpHeaders.dateHeader) ? HttpDate.parse(_data[HttpHeaders.dateHeader]!.join(',')) : null;

  @override
  set date(DateTime? value) => set(HttpHeaders.dateHeader, HttpDate.format(value!));

  @override
  DateTime? get expires =>
      _data.containsKey(HttpHeaders.expiresHeader) ? HttpDate.parse(_data[HttpHeaders.expiresHeader]!.join(',')) : null;

  @override
  set expires(DateTime? value) => set(HttpHeaders.expiresHeader, HttpDate.format(value!));

  @override
  DateTime? get ifModifiedSince => _data.containsKey(HttpHeaders.ifModifiedSinceHeader)
      ? HttpDate.parse(_data[HttpHeaders.ifModifiedSinceHeader]!.join(','))
      : null;

  @override
  set ifModifiedSince(DateTime? value) => set(HttpHeaders.ifModifiedSinceHeader, HttpDate.format(value!));
