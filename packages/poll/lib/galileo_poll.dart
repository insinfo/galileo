...
class PollingService extends Service {
  ...
  ///
  /// See https://github.com/galileo-dart/paginate.
...
*/
  ...
  Future update(id, data, [Map params]) {
    return inner.update(id, data, params).then(_handleUpdate).catchError(_onUpdated.addError);
  }

  @override
  Future modify(id, data, [Map params]) {
    return inner.modify(id, data, params).then(_handleUpdate).catchError(_onModified.addError);
  }
