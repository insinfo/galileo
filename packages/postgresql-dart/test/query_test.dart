...
void main() {
  group('Successful queries', () {
    ...
    test('Really long SQL string in execute', () async {
      final result = await connection.execute("INSERT INTO t (t) VALUES ('$lorumIpsum') returning t;");
      expect(result, 1);
    });
    ...
    test('Query without specifying types', () async {
      ...
      result = await connection
          .query('select i,s, bi, bs, bl, si, t, f, d, dt, ts, tsz, j, u, v, p, jj, ia, ta, da, ja from t');
      expect(result, [expectedRow]);
    });
    ...
    test('Can supply null for values (binary)', () async {
      final results = await connection
          .query('INSERT INTO n (i1, i2) values (@i1:int4, @i2:int4) returning i1, i2', substitutionValues: {
        'i1': null,
        'i2': 1,
      });
    ...
    test('Can supply null for values (text)', () async {
      final results =
          await connection.query('INSERT INTO n (i1, i2) values (@i1, @i2:int4) returning i1, i2', substitutionValues: {
        'i1': null,
        'i2': 1,
      });
    ...
    test('Overspecifying parameters does not impact query (binary)', () async {
      final results = await connection
          .query('INSERT INTO u (i1, i2) values (@i1:int4, @i2:int4) returning i1, i2', substitutionValues: {
        'i1': 0,
        'i2': 1,
        'i3': 0,
      });
    ...
    test('Can cast text to int on db server', () async {
      final results = await connection.query('INSERT INTO u (i1, i2) VALUES (@i1::int4, @i2::int4) RETURNING i1, i2',
  ...
  group('Unsuccesful queries', () {
    ...
    test('A query that fails on the server will report back an exception through the query method', () async {
      try {
        await connection.query('INSERT INTO t (i1) values (@i1)', substitutionValues: {'i1': 0});
        expect(true, false);
    ...
    test('Missing substitution value does not throw, query is sent to the server without changing that part.',
        () async {
      final rs1 = await connection.query('SELECT *  FROM (VALUES (\'user@domain.com\')) t1 (col1)');
    ...
    test('Wrong type for parameter in substitution values fails', () async {
      try {
        await connection
            .query('INSERT INTO t (i1, i2) values (@i1:int4, @i2:int4)', substitutionValues: {'i1': '1', 'i2': 1});
        expect(true, false);
    ...
    test('Invalid type code', () async {
      try {
        await connection
            .query('INSERT INTO t (i1, i2) values (@i1:qwerty, @i2:int4)', substitutionValues: {'i1': '1', 'i2': 1});
        expect(true, false);
      } on FormatException catch (e) {
