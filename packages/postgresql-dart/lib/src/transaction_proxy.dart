...
typedef _TransactionQuerySignature = Future<dynamic> Function(PostgreSQLExecutionContext connection);
...
class _TransactionProxy extends Object with _PostgreSQLExecutionContextMixin implements PostgreSQLExecutionContext {
  _TransactionProxy(this._connection, this.executionBlock, this.commitTimeoutInSeconds) {
    _beginQuery = Query<int>('BEGIN', {}, _connection, this, onlyReturnAffectedRowCount: true);

    _beginQuery.future.then(startTransaction).catchError((Object err, StackTrace st) {
      Future(() {
  ...
  Future _cancelAndRollback(dynamic object, [StackTrace? trace]) async {
    ...
    final rollback = Query<int>('ROLLBACK', {}, _connection, _transaction, onlyReturnAffectedRowCount: true);
