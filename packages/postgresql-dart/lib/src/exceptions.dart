...
class PostgreSQLException implements Exception {
  PostgreSQLException(this.message, {this.severity = PostgreSQLSeverity.error, this.stackTrace}) {
    code = '';
  }

  PostgreSQLException._(List<ErrorField> errorFields, {this.stackTrace}) {
    final finder = (int identifer) => (errorFields.firstWhere((ErrorField e) => e.identificationToken == identifer,
        orElse: () => ErrorField(null, null)));

    severity = ErrorField.severityFromString(finder(ErrorField.SeverityIdentifier).text);
