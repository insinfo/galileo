...
library galileo_isolate.test.ports_test;

import 'dart:async';
import 'dart:isolate';

import 'package:galileo_isolate/ports.dart';
...
void testSingleCallbackPort() {
  ...
  test('Timeout', () {
    var completer = Completer.sync();
    singleCallbackPort(completer.complete, timeout: _ms * 100, timeoutValue: 37);
    return completer.future.then((v) {
      expect(v, 37);
    });
  });
  ...
  test('TimeoutFirst', () {
    var completer = Completer.sync();
    var p = singleCallbackPort(completer.complete, timeout: _ms * 100, timeoutValue: 37);
...
void testSingleCompletePort() {
  ...
  test('TimeoutCallbackThrows', () {
    var completer = Completer.sync();
    singleCompletePort(completer, timeout: _ms * 100, onTimeout: () => throw 91);
    return completer.future.then((v) {
      fail('unreachable');
    }, onError: (e, s) {
      expect(e, 91);
  ...
  test('TimeoutCallbackFuture', () {
    var completer = Completer.sync();
    singleCompletePort(completer, timeout: _ms * 100, onTimeout: () => Future.value(87));
    return completer.future.then((v) {
      expect(v, 87);
    });
  });
  ...
  test('TimeoutCallbackThrowsFuture', () {
    var completer = Completer.sync();
    singleCompletePort(completer, timeout: _ms * 100, onTimeout: () => Future.error(92));
    return completer.future.then((v) {
      fail('unreachable');
    }, onError: (e, s) {
      expect(e, 92);
  ...
  test('TimeoutCallbackSLow', () {
    var completer = Completer.sync();
    singleCompletePort(completer, timeout: _ms * 100, onTimeout: () => Future.delayed(_ms * 500, () => 87));
    return completer.future.then((v) {
      expect(v, 87);
    });
  });
  ...
  test('TimeoutCallbackThrowsSlow', () {
    var completer = Completer.sync();
    singleCompletePort(completer, timeout: _ms * 100, onTimeout: () => Future.delayed(_ms * 500, () => throw 87));
    return completer.future.then((v) {
      fail('unreachable');
    }, onError: (e, s) {
      expect(e, 87);
  ...
  test('TimeoutFirst', () {
    var completer = Completer.sync();
    var p = singleCompletePort(completer, timeout: _ms * 100, onTimeout: () => 37);
    Timer(_ms * 500, () => p.send(42));
    return completer.future.then((v) {
      expect(v, 37);
    });
...
void testSingleResponseChannel() {
  ...
  test('TimeoutThrow', () {
    var channel = SingleResponseChannel(timeout: _ms * 100, throwOnTimeout: true);
    return channel.result.then((v) {
      fail('unreachable');
    }, onError: (v, s) {
  ...
  test('TimeoutThrowOnTimeoutAndValue', () {
    var channel =
        SingleResponseChannel(timeout: _ms * 100, throwOnTimeout: true, onTimeout: () => 42, timeoutValue: 42);
    return channel.result.then((v) {
      fail('unreachable');
    }, onError: (v, s) {
      expect(v is TimeoutException, isTrue);
  ...
  test('TimeoutOnTimeout', () {
    var channel = SingleResponseChannel(timeout: _ms * 100, onTimeout: () => 42);
    return channel.result.then((v) {
      expect(v, 42);
    });
  });
  ...
  test('TimeoutOnTimeoutAndValue', () {
    var channel = SingleResponseChannel(timeout: _ms * 100, onTimeout: () => 42, timeoutValue: 37);
    return channel.result.then((v) {
      expect(v, 42);
    });
  });
  ...
  test('TimeoutOnTimeoutError', () {
    var channel = SingleResponseChannel(timeout: _ms * 100, onTimeout: () => throw 42);
    return channel.result.then((v) {
      fail('unreachable');
    }, onError: (v, s) {
      expect(v, 42);
  ...
  test('TimeoutOnTimeoutAsync', () {
    var channel = SingleResponseChannel(timeout: _ms * 100, onTimeout: () => Future.value(42));
    return channel.result.then((v) {
      expect(v, 42);
    });
  });
  ...
  test('TimeoutOnTimeoutAsyncError', () {
    var channel = SingleResponseChannel(timeout: _ms * 100, onTimeout: () => Future.error(42));
    return channel.result.then((v) {
      fail('unreachable');
    }, onError: (v, s) {
      expect(v, 42);
