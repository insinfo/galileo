...
///     .sendPort
/// ```
SendPort singleCallbackPort<P>(void Function(P response) callback, {Duration timeout, P timeoutValue}) {
...
SendPort singleCompletePort<R, P>(Completer<R> completer,
    {FutureOr<R> Function(P message) callback, Duration timeout, FutureOr<R> Function() onTimeout}) {
...
Future<R> singleResponseFuture<R>(void Function(SendPort responsePort) action, {Duration timeout, R timeoutValue}) {
    ...
    if (timeout != null) {
      _timer = Timer(timeout, () {
        ...
        if (!_completer.isCompleted) {
          if (throwOnTimeout) {
            _completer.completeError(TimeoutException('Timeout waiting for response', timeout));
