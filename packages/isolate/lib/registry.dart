...
library galileo_isolate.registry;
  ...
  Future<Capability> add(T element, {Iterable tags}) {
    ...
    if (cache.contains(element)) {
      return Future<Capability>.sync(() {
        throw StateError('Object already in registry: ${Error.safeToString(element)}');
      });
    }
...
class RegistryManager {
  ...
  /// [Isolate.spawn].
  Registry get registry => Registry.fromPort(_commandPort.sendPort, timeout: _timeout);
