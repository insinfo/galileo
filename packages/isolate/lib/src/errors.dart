...
library galileo_isolate.errors;
...
class MultiError extends Error {
  ...
  /// [wait]).
  static Future<List<Object>> waitUnordered<T>(Iterable<Future<T>> futures, {void Function(T successResult) cleanUp}) {
  ...
  Future<List<Object>> wait<T>(Iterable<Future<T>> futures, {void Function(T successResult) cleanUp}) {
    Completer<List<Object>> completer;
    var count = 0;
    var hasError = false;
    var completed = 0;
