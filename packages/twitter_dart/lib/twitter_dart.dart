...
class Twitter {
  ...
  factory Twitter(String consumerKey, String consumerSecret, String accessToken, String accessSecret) {
    oauth.Tokens oauthTokens = new oauth.Tokens(
        consumerId: consumerKey, consumerKey: consumerSecret, userId: accessToken, userKey: accessSecret);
  ...
  Future<http.Response> request(String method, String endPoint, {Map<String, String> body}) {
