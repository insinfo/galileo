...
abstract class ReflectedInstance {
  ...
  @override
  bool operator ==(other) => other is ReflectedInstance && other.type == type && other.clazz == clazz;
...
abstract class ReflectedType {
  ...
  bool operator ==(other) =>
      ...
      other.name == name &&
      const ListEquality<ReflectedTypeParameter>().equals(other.typeParameters, typeParameters) &&
...
abstract class ReflectedClass extends ReflectedType {
  ...
  @override
  int get hashCode => hash4(super.hashCode, annotations, constructors, declarations);

  @override
  bool operator ==(other) {
    if (other is ReflectedClass && other.annotations != null) {
      return other is ReflectedClass &&
          super == other &&
          const ListEquality<ReflectedInstance?>().equals(other.annotations, annotations) &&
          const ListEquality<ReflectedFunction?>().equals(other.constructors, constructors) &&
          const ListEquality<ReflectedDeclaration?>().equals(other.declarations, declarations);
    }
    return false;
  }
}
...
class ReflectedDeclaration {
  ...
  @override
  bool operator ==(other) =>
      other is ReflectedDeclaration && other.name == name && other.isStatic == isStatic && other.function == function;
}
...
abstract class ReflectedFunction {
  ...
  @override
  int get hashCode => hashObjects([name, typeParameters, annotations, returnType, parameters, isGetter, isSetter]);
  ...
  bool operator ==(other) =>
      ...
      const ListEquality<ReflectedParameter>().equals(other.parameters, other.parameters) &&
...
class ReflectedParameter {
  ...
  @override
  int get hashCode => hashObjects([name, annotations, type, isRequired, isNamed]);
...
class ReflectedTypeParameter {
  ...
  @override
  bool operator ==(other) => other is ReflectedTypeParameter && other.name == name;
}
