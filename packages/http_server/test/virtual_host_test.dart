  ...
  group('virtual host', () {
    ...
    group('domain', () {
      test('specific-sub-domain', () async {
        ...
        expect(await Future.wait(statusCodes), equals([HttpStatus.ok, HttpStatus.ok, HttpStatus.ok]));
      });
    ...
    test('multiple-source-https', () async {
      var secondServer = await HttpServer.bindSecure('localhost', 0, serverContext);
      ...
      var statusCodes = await Future.wait([
        ...
        fetchStatusCode(secondServer.port, '/', host: 'myhost2.com', secure: true)
      ]);
