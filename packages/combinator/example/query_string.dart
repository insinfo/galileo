...
final Parser key = match(new RegExp(r'[^=&\n]+'), errorMessage: 'Missing k/v').value((r) => r.span.text);

final Parser value = key.map((r) => Uri.decodeQueryComponent(r.value as String));
...
final Parser pairs = pair.separatedBy(match(r'&')).map((r) => r.value.reduce((a, b) => a..addAll(b)));
