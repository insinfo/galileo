...
final Parser<String> string =
    match<String>(new RegExp(r'[^:$]+'), errorMessage: 'Expected a string.').value((r) => r.span.text);
...
final Parser<Map<String, String>> credentials = chain<String>([
  ...
  match<String>(':'),
  string.opt(),
]).map<Map<String, String>>((r) => {'username': r.value[0], 'password': r.value[2]});
