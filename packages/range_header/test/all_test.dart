...
final Matcher throwsRangeParseException = throwsA(const TypeMatcher<RangeHeaderParseException>());
...
main() {
  ...
  group('exceptions', () {
    ...
    test('no dash after int', () {
      ...
      expect(() => new RangeHeader.parse('bytes 3,'), throwsRangeParseException);
      expect(() => new RangeHeader.parse('bytes 3 24'), throwsRangeParseException);
    });
  ...
  test('content-range', () {
    expect(new RangeHeader.parse('bytes 1-2').items[0].toContentRange(3), '1-2/3');
  });
}
