...
class UserAgent {
  ...
  static const List<String> knownTabletUserAgentKeywords = const ["ipad", "playbook", "hp-tablet", "kindle"];
  ...
  bool get isBlackberry => contains('blackberry') || contains('bb10') || contains('rim');
