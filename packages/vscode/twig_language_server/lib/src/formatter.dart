...
class TwigFormatter {
  ...
  TwigFormatter(this.tabSize, this.insertSpaces) {
  ...
  void _formatElement(Element element) {
    ...
    if (element is SelfClosingElement) {
      ...
      if (element.children.length == 1 && (element.children.first is Text || element.children.first is TextNode)) {
        _buffer.write('>');
      ...
      if (element.children.isNotEmpty && (element.children.last is Text || element.children.last is TextNode)) {
        _buffer.writeln();
      }
